					...
					<div id="submitdiv" class="postbox ">
						...
						<div class="inside">
							<div class="submitbox" id="submitpost">
								...
								<div style="padding: 10px;"><input type="submit" value="   <?php esc_html_e( ' Save', 'wc4bp' ); ?>" class="button"></div>
								<div class="clear"></div>
							</div>
	...
	<div id="tabs">
		...
		if ( ! empty( $groups ) ) :
			...
			<div id="tabs-<?php echo esc_attr( $group->id ); ?>" class="tab-wrapper">
					...
					<h3><?php echo esc_attr( $group->name ); ?>  <?php esc_html_e( ' WooCommerce fields are already in the checkout and get synced with BuddyPress.', 'wc4bp' ); ?> </h3>
				<?php } ?>
						...
						<div class="fields">
							<div class="field cv-enabled">
								<label>
									...
									<?php
									esc_html_e(
										'Make this group hidden on the checkout page, unless at least ' .
							...
							">
								<label>
									...
									<?php
									esc_html_e(
										'Display this group if the cart contains a product from any of ' .
		...
		endforeach;
			...
			<div id="message" class="error"><p><?php esc_html_e( 'You have no groups.', 'wc4bp' ); ?></p></div>
